    ...
    if usr_cmd == "/start":
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="<i>𝓢𝓸𝓶𝓮𝓽𝓱𝓲𝓷𝓰 𝔀𝓮𝓷𝓽 𝔀𝓻𝓸𝓷𝓰</i> <b> <a href='https://t.me/itx_phantom'>CLICK HERE FOR SUPPORT </a></b>",
                    parse_mode="HTML",
                    disable_web_page_preview=True)
                return
        await m.reply_text(
...
<i>It is your responsibility to use wisely I dont take responsibilities of any voilations(of any kind)</i>\n
<i><u>𝗪𝗔𝗥𝗡𝗜𝗡𝗚 🚸</u></i>\n
<b>Dont Spam.</b>""",
            parse_mode="HTML",
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('👑 Owner', url=f"https://t.me/itx_phantom"),
        ...
        if Var.UPDATES_CHANNEL != "None":
            try:
                ...
                if user.status == "kicked":
                    await b.send_message(
                        chat_id=m.chat.id,
                        text="**Sᴏʀʀʏ Sɪʀ, Yᴏᴜ ᴀʀᴇ Bᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴍᴇ. Qᴜɪᴄᴋʟʏ ᴄᴏɴᴛᴀᴄᴛ** @itx_phantom",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await b.send_message(
                    chat_id=m.chat.id,
                    text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ** [➳⚡️𝔗𝔥𝔢 𝔉𝔩𝔞𝔰𝔥⚡️༻](https://t.me/phant0m_media).",
                    parse_mode="markdown",
                    disable_web_page_preview=True)
                return
...
"""
        ...
        await m.reply_text(
            ...
            parse_mode="HTML",
            reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🖥 𝖲𝗍𝗋𝖾𝖺𝗆", url=stream_link), #Stream Link
                                                InlineKeyboardButton('𝖣𝗈𝗐𝗇𝗅𝗈𝖺𝖽 📥', url=online_link)]]) #Download Link
        )
...
async def help_handler(bot, message):
    ...
    if Var.UPDATES_CHANNEL is not None:
        try:
            ...
            await bot.send_message(
                chat_id=message.chat.id,
                text="__Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ. Cᴏɴᴛᴀᴄᴛ ᴍᴇ__ ➳⚡️𝔗𝔥𝔢 𝔉𝔩𝔞𝔰𝔥⚡️༻](https://t.me/phant0m_media).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
    ...
    await message.reply_text(
       text="Send me any file/media from telegram, I'll provide external direct download link..",
          ...
          reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("😇Donate", url="https://t.me/phant0m_media")]
            ]
        )
    )
